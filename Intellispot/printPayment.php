                ...
                <div class="formContainer">
                    <form action="">
                        ...
                        <div class="input_box">
                            ...
                            <input type="text" id="reference" name="reference" value="Renew Sticker" disabled/>
                        </div>

                        <div class="input_box">
                            <label for="">Amount : </label>
                            <input type="text" id="amount" name="amount" value="RM30.00" disabled/>
                        </div>

                        <button type="button" onclick="location.href='printPaymentSuccess.php'">Pay Now</button>
                        <br>
                        <br>
